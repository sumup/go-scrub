[![Builds](https://github.com/sumup/go-scrub/workflows/Build/badge.svg?branch=master)](https://github.com/sumup/go-scrub/actions?query=branch%3Amaster+workflow%3ABuild)
